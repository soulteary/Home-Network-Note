...
| ~~工控机~~ | D525 ^4 | 已送人 | 2016 |
| ~~工控机~~ | D425 ^5 | 已丢弃 | 2015 |
| ~~代码仓库~~ | ONDA v939 Core M ^6 | 4G LTE / 2G WIFI / 4GBRAM / 128GB | 2016 |
| ~~资源备份x3~~ | DSM 兼容机 ^7 | 千兆LAN | 2016 / 2017 |
| ~~功能机器~~ | N3700组装机  ^8 | N3700 1.6GHz 千兆LANx4 & 5G WIFI /16GBRAM / mixed | 2016 |
| ~~资源机器~~ | HASEE Z7    ^9 | 千兆LAN & 5G WIFI / 32GBRAM / 1T SSD  | 2015 |
| 爪机 | iP5s ^10 | 4G / 5G WIFI | 忽略  | 2017 |
| 爪机 | iP5 ^11 | 3G / 5G WIFI | 16G | 2017 |
| 爪机 | S7E ^12 | 4G / 5G WIFI | 忽略 | 2016 |
...
- [8] 把视频投屏放在老的Mac上，文件服务放在DS718后，这台机器就闲置了。
- [9] i7 2.6GHz, 配合`hotkey`软件调节节能模式，性能表现极好，已送人。
- [10] 之前diy外壳的玩具，在之前公司上班的时候比较反感要安装手机证书，于是作为工作备机使用，隔离工作和生活数据，不需要考虑备份功能。
- [11] 另外一个diy外壳的玩具，作为家里MP4使用，投个音乐不用考虑电话进来，游戏音干扰，挺好的。
- [12] 没有特别需求，不会再入三星的机器了，稍后补充吐槽（关于闪付／更新），目前当NFC充值POS机使用，冲地铁卡。
